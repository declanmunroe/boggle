...
class TestBoggle(unittest.TestCase):
    ...
    def test_grid_size_is_width_times_heigth(self):
        """
        Test to ensure that the total size of the grid is
        equal to width * heigth
        """
    ...
    def test_all_grid_neighbours(self):
        ...
        for pos in grid:
            others = list(grid) #creates a new list from the dictionarys keys
            others.remove(pos)
    ...
    def test_search_grid_for_words(self):
        ...
        self.assertFalse(notThereWord in foundWords)
